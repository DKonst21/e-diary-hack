...
```
remove_chastisements('Сергей Сыроежкин')
```
...
```
create_commendation('Сергей Сыроежкин', Физика)
```
...
- `DEBUG` — debug-режим. Поставьте True, чтобы увидеть отладочную информацию в случае ошибки.
